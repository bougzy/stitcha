...
export const measurementSchema = z.object({
  ...
  weight:       optNum(300),
  // New measurements
  underBust:      optNum(200),
  roundArm:       optNum(80),
  blouseLength:   optNum(150),
  fullLength:     optNum(250),
  halfLength:     optNum(100),
  halfSleeve:     optNum(60),
  crotchLength:   optNum(100),
  shoulderToBust: optNum(50),
  shoulderToHip:  optNum(80),
});
